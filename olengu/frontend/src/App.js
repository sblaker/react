...
import ShowBooksHostSospeso from './Pages/ShowBooksHostSospeso';
import ShowBooksHostAttivo from './Pages/ShowBooksHostAttivo';
import ShowBooksHostInCorso from './Pages/ShowBooksHostInCorso';
import ShowBooksHostConcluso from './Pages/ShowBooksHostConcluso';
    ...
    <Router>
      <Switch>
        <div className="Home">
          ...
          <Route path="/ShowBooksHost/:id_ann" component={ShowBooksHostDetails} />
          <Route path="/BooksInCorso" exact component={BooksInCorso} />
          <Route path="/BooksInCorso/:id_ann" component={InCorsoDetails} />
          <Route path="/BooksAttive" exact component={BooksAttive} />
          <Route path="/BooksAttive/:id_ann" component={AttiveDetails} />
          <Route path="/BooksInSospeso" exact component={BooksInSospeso} />
          <Route path="/BooksInSospeso/:id_ann" component={InSospesoDetails} />
          <Route path="/BooksConcluse" exact component={BooksConcluse} />
          <Route path="/BooksConcluse/:id_ann" component={ShowBooksHostDetails} />
          <Route path="/Payment" component={Payment} />
          <Route path="/CheckOut" component={CheckOut} />
          <Route path="/CheckIn" component={CheckIn} />
          <Route path="/ShowBooksHostSospeso" component={ShowBooksHostSospeso} />
          <Route path="/ShowBooksHostAttivo" component={ShowBooksHostAttivo} />
          <Route path="/ShowBooksHostInCorso" component={ShowBooksHostInCorso} />
          <Route path="/ShowBooksHostConcluso" component={ShowBooksHostConcluso} />
          <Footer /> 
        </div>
      </Switch>
    </Router>
